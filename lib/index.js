...
var Swipeable = function (_PureComponent) {
  ...
  _createClass(Swipeable, [{
    ...
    key: 'openRightButtons',
    value: function openRightButtons() {
      var _props7 = this.props,
          rightButtons = _props7.rightButtons,
          rightButtonWidth = _props7.rightButtonWidth;

      _reactNative.Animated.timing(this.state.pan.x, {
        toValue: -(rightButtons.length * rightButtonWidth),
        duration: 200,
        easing: _reactNative.Easing.elastic(0.5)
      }).start();
      this.setState({
        lastOffset: { x: -(rightButtons.length * rightButtonWidth), y: 0 }
      });
      this.setState({ rightButtonsActivated: true });
    }
  }, {
    key: 'render',
    value: function render() {
      var _props8 = this.props,
          ...
          contentContainerStyle = _props8.contentContainerStyle,
          leftButtons = _props8.leftButtons,
          leftContainerStyle = _props8.leftContainerStyle,
          leftContent = _props8.leftContent,
          rightButtons = _props8.rightButtons,
          rightContainerStyle = _props8.rightContainerStyle,
          rightContent = _props8.rightContent,
          style = _props8.style,
          props = _objectWithoutProperties(_props8, ['children', 'contentContainerStyle', 'leftButtons', 'leftContainerStyle', 'leftContent', 'rightButtons', 'rightContainerStyle', 'rightContent', 'style']);
